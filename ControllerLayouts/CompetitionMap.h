...
ADD_BUTTON(1, RightTrigger, WhileHeld, new ShooterMoveCommand(-Config::Shooter::pivotSpeed));
ADD_BUTTON(1, RightBumper, WhileHeld, new ShooterMoveCommand(Config::Shooter::pivotSpeed));
