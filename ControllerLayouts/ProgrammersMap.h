...
ADD_BUTTON(0, RightTrigger, WhenPressed, new SetShooterHeightCommand(Config::Shooter::minHeight));
ADD_BUTTON(0, RightBumper, WhenPressed, new SetShooterHeightCommand(Config::Shooter::maxHeight));
ADD_BUTTON(0, A, WhenPressed, new SetPickupArmsHeightCommand(Config::PickupArms::liftedPortcullisHeight));
ADD_BUTTON(0, LeftBumper, WhenPressed, new SetPickupArmsHeightCommand(Config::PickupArms::maxHeight));
ADD_BUTTON(0, LeftTrigger, WhenPressed, new SetPickupArmsHeightCommand(Config::PickupArms::minHeight));
ADD_BUTTON(0, Start, WhenPressed, new LaunchBoulderCommand());
