...
ADD_BUTTON(0, RightTrigger, WhenPressed, new SetShooterHeightCommand(-30));
...
ADD_BUTTON(0, LeftTrigger, WhenPressed, new SetPickupArmsHeightCommand(Config::PickupArms::ballRollerHeight));
