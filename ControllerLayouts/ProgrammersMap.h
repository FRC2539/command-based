...
ADD_BUTTON(0, DPadUp, WhileHeld, new ButtonMecanumDriveCommand(0, .25));
ADD_BUTTON(0, DPadDown, WhileHeld, new ButtonMecanumDriveCommand(0, -.25));
ADD_BUTTON(0, DPadRight, WhileHeld, new ButtonMecanumDriveCommand(.25, 0));
ADD_BUTTON(0, DPadLeft, WhileHeld, new ButtonMecanumDriveCommand(-.25, 0));
